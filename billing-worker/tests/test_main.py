...
@patch('src.main.NotificationScheduleHandler')
...
def test_main(
    ...
    mock_notification_schedule_handler,
    ...
    mock_notification_service.assert_called_with(settings, mock_sns_client.return_value)
    ...
    mock_notification_schedule_handler.assert_called_with(settings, mock_redis_client.return_value, mock_notification_service.return_value)
